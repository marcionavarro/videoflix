<div class="max-w-7xl mx-auto mt-10 py-6 px-4 sm:px-6 lg:px-8">
    ...
    <form action="" wire:submit.prevent="editVideo">
        ...
        <div class="w-full mb-5">
            ...
            <input type="text" wire:model.defer="video.name"
                   class="w-full @error('video.name') border-red-700 @enderror">
        ...
        <div class="mb-5">
            ...
            <input type="text" wire:model.defer="video.description"
                   class="w-full @error('video.description') border-red-700 @enderror">
        ...
        <div class="w-full flex justify-between mb-5">
            ...
            <div class="w-2/3">
                @if($thumb)
                    <img src="{{$thumb->temporaryUrl()}}" alt="Thumb do Vídeo {{$video->name}}"
