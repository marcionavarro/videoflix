<div class="max-w-7xl mx-auto mt-10 py-6 px-4 sm:px-6 lg:px-8">
        ...
        <div class="w-full flex bg-white py-2 px-10 rounded mb-10 border border-gray-300">
            ...
            <div>
                <p>{{ $notification->data['message'] }}
                    <a href="#"  class="underline text-blue-500" wire:click.prevent="markAsReadNotification('{{$notification->id}}')">
                        Marcar como lido
                    </a>
                </p>
                <p>
    ...
    @empty
        <div class="w-full py-5 px-10 border border-yellow-500 bg-yellow-100 text-yellow-500">Nenhuma notificação encontrada...</div>
    @endforelse
</div>
