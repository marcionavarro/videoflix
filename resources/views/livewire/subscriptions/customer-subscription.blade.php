<div class="max-w-7xl mx-auto mt-10 py-6 px-4 sm:px-6 lg:px-8">
    ...
    <div class="rounded bg-gray-800 p-2">
        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <thead>
            <tr>
                <th class="px-6 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">Data Cobrança
                </th>
                <th class="px-6 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">Valor Cobrado
                </th>
